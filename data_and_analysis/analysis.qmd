...
df_ranking_by_condition <- df_ranking |> 
  ...
  mutate(number_logical = sum(logical_pass)) |> 
  dplyr::select(id, condition, number_logical) |> 
  unique()

summary_table2 <- df_ranking_by_condition |> 
  group_by(condition) |> 
...
(wrap_elements(p_wmc) / wrap_elements(p_gf)) +
  plot_annotation(tag_levels = "A") &
  theme(plot.tag = element_text(face = "bold", size = 12))

ggsave("z1_6_wmc_gf.pdf", width = 7, height = 7)
