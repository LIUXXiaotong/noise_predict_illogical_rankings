...
library("pacman")
p_load(tidyverse, here, GGally, ppcor, lme4, lmtest)
...
#)
ggsave(
  filename = file.path(plots_dir, "noise_ranking_conjdisj_exclu.png"),
  plot = p1,
  width = 6.4, height = 6.4,
  dpi = 300
)
...
#)
ggsave(
  filename = file.path(plots_dir, "noise_illogical_HMT_WMC_exclu.png"),
  plot = p2,
  width = 7, height = 7,
  dpi=300
)
